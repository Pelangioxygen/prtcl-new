...
export const pages:PageContent = {
				...
				slider: [
					{
						...
						heading: "Dr. Maria Lopez, MD",
						stars: 5,
						description: "I’ve referred several of my patients to PRTCL for advanced tissue recovery, and the results have been consistently outstanding. Their strict medical protocols and responsive team make my job so much easier."
					},
					{
						key: "coordinator",
						label: "Doctor",
						color: "yellow",
						subheading: "Post-surgical recovery",
						heading: "Dr. Jonathan Kim, MD",
						stars: 5,
					...
					},
					{
						...
						label: "Patient",
						color: "green",
						subheading: "Radiation Recovery Patient",
						heading: "Jennifer Moore",
						stars: 5,
						description: "PRTCL gave me my quality of life back. I felt cared for from the first day, and the results were better than I ever expected.",
					},
					{
						key: "doctor2",
						label: "Doctor",
						...
						heading: "Dr. Rebecca Allen, DO",
						stars: 5,
						description: "I trust PRTCL with my post-op patients because their team delivers measurable improvements and communicates clearly every step of the way",
					},
					{
						key: "coordinator43254",
						label: "Coordinator",
						color: "yellow",
						subheading: "Wound Clinic Coordinator",
						heading: "Sarah Patel",
						stars: 5,
						description: "Our clinic has been referring patients to PRTCL for over a year now. Their dedication to clinical excellence and patient support stands out every time.",
					},
					{
						key: "doctor3",
						label: "Doctor",
						color: "blue",
						subheading: "Oncology Specialist",
						heading: "Dr. David Nguyen, MD",
						stars: 5,
						description: "I’ve seen remarkable recovery rates in patients post-radiation. PRTCL’s hyperbaric program truly elevates the standard of care.",
					},
					{
						key: "coordinator4324",
						label: "Coordinator",
						color: "yellow",
						subheading: "Patient Care Coordinator, Pacific Medical Group",
						heading: "Emily Carter",
						stars: 5,
						description: "Coordinating with PRTCL is seamless. Their team is professional, fast to respond, and truly invested in each patient’s recovery journey",
					},
					{
						key: "patient5454222",
						label: "Patient",
						color: "green",
						subheading: "Post-surgery patient",
						heading: "Michael Davis",
						stars: 5,
						description: "After my surgery, I was nervous about healing. The PRTCL team made me feel safe, informed, and supported through every session.",
					},
					{
						key: "coordinator432411",
						label: "Coordinator",
						color: "yellow",
						subheading: "Oncology Center Coordinator",
						heading: "James Walker",
						stars: 5,
						description: "PRTCL has proven to be an exceptional partner. Patients return with better outcomes, and communication with their staff is always effortless.",
					},

					{
						...
						label: "Patient",
						color: "green",
						subheading: "Chronic wound patient",
						heading: "Linda Thompson",
						stars: 5,
						description: "My wound finally started healing after months of no progress. The staff at PRTCL treated me like family — I’m beyond grateful.",
					}
				],
			},
			{
		...
		sections: [
			...
			},
			{
				...
				children: <div>
					...
					<p>Not sure which option is best for you? <Link href={'/contacts#submit-to-google-sheet'}>Contact our team</Link> for personalized guidance.</p>
				</div>
			}
		],
	},
	...
	privacy: {
		...
		sections: [
			...
			{
				type: "privacy",
				leading: <p>Welcome to the Health PRTCL website, mobile app, and related sites and digital and online services (“Health PRTCL Site,” the “Site,” or “Sites”), an online e-commerce, information, and communications service provided by Health PRTCL and all affiliates (“Health PRTCL” or “We” or “Us”).</p>,
				children: <>
						<p>We take your privacy seriously, and we want you to know how we collect, use, share, and protect your information. In addition to this privacy policy (“Privacy Policy”), users of the Health PRTCL Site should consult the Health PRTCL Site Terms of Use as well as any product-specific terms and conditions that apply. You may review policies specifically related to patient information (protected health information or PHI) submitted through Health PRTCL&apos;s Patient Portal.</p>
						<p>This Privacy Policy applies to all Sites where it is posted. Other Health PRTCL online properties may have their own privacy policies that apply to those sites. You should review those privacy policies in connection with your use of those sites.</p>
						<h3>What information we collect</h3>
						<p>Information you give us: We respect the right to privacy of all visitors to the Health PRTCL Sites. We receive and store some information that you enter on our Sites or that you provide to us through the Sites in any other way.
						...
						<ul>
							...
							<li>Promotional Offers from Health PRTCL. If you do not wish to have your email address used by us to promote our own products and services, you can opt-out at any time by clicking the unsubscribe link at the bottom of any email or other marketing communications you receive from us or submitting a request to our Preference Center. This opt-out does not apply to information provided to Health PRTCL as a result of a product purchase or your use of our services. If you wish to opt-out of such sharing, please email us at <a href="mailto:info@healthprtcl.com">info@healthprtcl.com</a>.</li>
